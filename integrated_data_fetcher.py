...
try:
    ...
    SYMBOL_NAMES = {
        'A': '豆一', 'AG': '白银', 'AL': '沪铝', 'AU': '黄金',
        'BR': '丁二烯橡胶', 'BU': '沥青', 'BZ': '氧化铝', 'C': '玉米', 'CF': '棉花', 'CU': '沪铜', 'CY': '棉纱',
        'EB': '苯乙烯', 'EG': '乙二醇', 'FG': '玻璃', 'FU': '燃油', 'HC': '热卷',
        'I': '铁矿石', 'JD': '鸡蛋', 'JM': '焦煤', 'L': '聚乙烯',
        'LC': '碳酸锂', 'LH': '生猪', 'M': '豆粕', 'MA': '甲醇',
        'NI': '镍', 'OI': '菜籽油', 'P': '棕榈油', 'PB': '铅',
        'PF': '短纤', 'PG': '液化石油气', 'PP': '聚丙烯', 'PR': '瓶片', 'PS': '多晶硅',
        'PX': '对二甲苯', 'RB': '螺纹钢', 'RM': '菜籽粕', 'RU': '天然橡胶', 'SA': '纯碱',
        'SF': '硅铁', 'SH': '烧碱', 'SI': '工业硅', 'SM': '锰硅', 'SN': '锡', 'SP': '纸浆',
        'SR': '白糖', 'SS': '不锈钢', 'TA': 'PTA', 'UR': '尿素', 'V': 'PVC',
        'WR': '线材', 'Y': '豆油', 'ZN': '锌'
    }

# 交易所品种映射（完全匹配basis目录的52个品种）
EXCHANGE_SYMBOLS = {
    "大商所": ['A', 'C', 'M', 'Y', 'P', 'I', 'JM', 'JD', 'L', 'PP', 'V', 'EB', 'EG', 'PG', 'LH', 'BZ'],  # 移除B,J 添加BZ
    "郑商所": ['CF', 'CY', 'FG', 'MA', 'OI', 'RM', 'SA', 'SF', 'SM', 'SR', 'TA', 'UR', 'PF', 'PX', 'PR', 'SH', 'WR'],  # 移除SI 添加PR,SH,WR
    "上期所": ['AL', 'AU', 'AG', 'BU', 'CU', 'FU', 'HC', 'NI', 'PB', 'RB', 'RU', 'SN', 'SP', 'SS', 'ZN', 'BR'],  # 移除NR,LU
    "中金所": ['IC', 'IF', 'IH', 'IM', 'T', 'TF', 'TS', 'TL'],  # 基差数据中不包含中金所品种
    "广期所": ['LC', 'SI', 'PS']  # SI(工业硅)属于广期所
}
